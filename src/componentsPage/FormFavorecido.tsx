...
const Transition = forwardRef(function Transition(
    ...
    const FormFavorecido = (props: any) => {
        ...
        const salva = () => {
            ...
            if (props.favorecido_id) {
    
    
                api.put(`favorecido/${props.favorecido_id}`, dataPost).then((result) => {
                ...
                api.post('favorecido', dataPost).then((result) => {
    ...
    const carregaFavorecido = () => {
        ...
        api.post(`favorecidoListaUm/${props.favorecido_id}`, dataPost).then((result) => {
    ...
    useEffect(() => {
        ...
        if (props.favorecido_id != null && props.cliente_id != null) {
            carregaFavorecido()
          }

    }, [props.farovecido_id, props.cliente_id])
    ...
    useEffect(() => {
        ...
        console.log(tipoJuridico, cliente_id)
            ...
            <div>
                ...
                <div className="row g-3">
...

                    {
                        cliente_id && tipoJuridico && (
                            ...
                            >
                                ...
                                {(validadoCPF == true || props.favorecido_id || validadoCNPJ == true) && (
                    ...
                    <div className="col-md-12" style={{ marginTop: 50, textAlign: 'right' }}>
                        ...
                        <button type="button" className="btn btn-success" style={{ marginLeft: 5, display: validadoCPF == true || props.favorecido_id || validadoCNPJ == true ? 'table-row' : 'none' }} onClick={validaSalvar}>Salvar</button>
